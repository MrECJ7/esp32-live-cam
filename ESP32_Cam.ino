...
const char* ssid     = "Nobita";   //your network SSID
const char* password = "ar@51/er";   //your network password
const char* websocket_server_host = "172.245.11.164";
const uint16_t websocket_server_port = 65080;

String myScript = "/macros/s/AKfycbxoj84wezISXMft5ihlGKnaUH6SvpL6XYtAqFKY-atMqRJQox9kpuHkyZJoW0fjO8sA/exec";    //Create your Google Apps Script and replace the "myScript" path.
String myLineNotifyToken = "myToken=zHJ0D1CBctRkCyjiJhpamzePDbcdncw4DHkaRsub15k";    //Line Notify Token. You can set the value of xxxxxxxxxx empty if you don't want to send picture to Linenotify.
